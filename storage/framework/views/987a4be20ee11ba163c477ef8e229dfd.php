...
<head>
    ...
    <?php if(($themFavicon ?? null)): ?>
        <link rel="icon" type="image/png" href="<?php echo e($themFavicon); ?>">
    <?php elseif(($themHeaderLogo ?? null)): ?>
        <link rel="icon" type="image/png" href="<?php echo e($themHeaderLogo); ?>">
    <?php else: ?>
        <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='8' fill='<?php echo e(urlencode($themColor ?? '#173b9f')); ?>'/%3E%3Ctext x='16' y='23' text-anchor='middle' font-family='Arial' font-weight='900' font-size='20' fill='white'%3EE%3C/text%3E%3C/svg%3E">
    <?php endif; ?>
    ...
    <style>
        :root {
            --menu-color:   <?php echo e($themeColorSafe); ?>;
            --primary:      <?php echo e($themeColorSafe); ?>;
            --primary-dark: <?php echo e($themeColorSafe); ?>;
        }
        /* ── Sidebar ── */
        .sidebar {
            width: 288px; height: 100vh;
            background-color: var(--menu-color);
            <?php if($themeBgSafe): ?> /* bg-color sert de couleur de fond alternative */
            background: linear-gradient(160deg, var(--menu-color) 0%, <?php echo e($themeBgSafe); ?> 100%);
            <?php endif; ?>
    ...
    <div class="px-5 py-5 flex-shrink-0 border-b border-white/10">
        <div class="flex items-center gap-3">
            <div class="h-11 w-11 rounded-xl bg-white/90 overflow-hidden flex items-center justify-center flex-shrink-0 shadow-sm">
                <?php if($sidebarLogo): ?>
                    <img src="<?php echo e($sidebarLogo); ?>" alt="<?php echo e($sidebarAdminName); ?>"
    ...
    ?>
        ...
        <a href="<?php echo e(route('dashboard')); ?>"
           class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            <i class="fas fa-th-large"></i> <?php echo e(__('navigation.dashboard')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('courrier')): ?>
        <?php
        ...
        ?>
        <a href="<?php echo e($courrierEntryRoute); ?>"
           class="nav-link <?php echo e(request()->routeIs('courrier.*') ? 'active' : ''); ?>">
            <i class="fas fa-envelope-open"></i> <?php echo e(__('navigation.mail_management')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('documents')): ?>
        <a href="<?php echo e(route('documents.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('documents.*') ? 'active' : ''); ?>">
            <i class="fas fa-file-alt"></i> <?php echo e(__('navigation.my_documents')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('templates-shared')): ?>
        <a href="<?php echo e(route('shared-templates.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('shared-templates.*') ? 'active' : ''); ?>">
            <i class="fas fa-layer-group"></i> <?php echo e(__('navigation.shared_templates')); ?>
        ...
        <a href="<?php echo e(route('workflows.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('workflows.*') ? 'active' : ''); ?>">
            <i class="fas fa-code-branch"></i> <?php echo e(__('navigation.workflows')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('signatures')): ?>
        <a href="<?php echo e(route('signatures.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('signatures.*') ? 'active' : ''); ?>">
            <i class="fas fa-pen-nib"></i> <?php echo e(__('navigation.signatures')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('reception')): ?>
        <a href="<?php echo e(route('reception.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('reception.*') ? 'active' : ''); ?>">
            <i class="fas fa-inbox"></i> <?php echo e(__('navigation.reception')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('act-requests')): ?>
        <a href="<?php echo e(route('act-requests.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('act-requests.*') ? 'active' : ''); ?>">
            <i class="fas fa-clipboard-list"></i> <?php echo e(__('navigation.act_requests')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('personnel')): ?>
        <a href="<?php echo e(route('admin.index', ['tab' => 'personnel'])); ?>"
           class="nav-link <?php echo e(request()->routeIs('admin.*') && request('tab') === 'personnel' ? 'active' : ''); ?>">
            <i class="fas fa-id-badge"></i> Gestion du personnel
        </a>
        <?php endif; ?>

        <?php if($canMenu('meetings')): ?>
        <a href="<?php echo e(route('meetings.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('meetings.*') || request()->routeIs('meetings.rooms.*') ? 'active' : ''); ?>">
            <i class="fas fa-people-group"></i> Réunions
        </a>
        <?php endif; ?>

        <?php if($canMenu('qrcode')): ?>
        <a href="<?php echo e(route('qr-verification.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('qr-verification.*') ? 'active' : ''); ?>">
            <i class="fas fa-qrcode"></i> <?php echo e(__('navigation.qr_verification')); ?>

        </a>
        <?php endif; ?>

        <?php if($canMenu('administration')): ?>
        <div class="nav-section"><?php echo e(__('navigation.administration')); ?></div>
        <a href="<?php echo e(route('admin.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('admin.*') && request('tab') !== 'personnel' ? 'active' : ''); ?>">
            <i class="fas fa-shield-alt"></i> <?php echo e(__('navigation.administration')); ?>
...
<div class="main-content min-h-screen flex flex-col">
    ...
    <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-30 gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 leading-tight"><?php echo $__env->yieldContent('page-title', 'Tableau de bord'); ?></h1>
            <p class="text-sm text-gray-400 mt-0.5"><?php echo $__env->yieldContent('page-subtitle', ''); ?></p>
        </div>
        <div class="flex items-center gap-4 flex-shrink-0">
            <?php if(session('success')): ?>
                <span class="text-green-700 text-sm bg-green-50 border border-green-200 px-3 py-1.5 rounded-full flex items-center gap-1.5">
                    <i class="fas fa-check-circle text-green-500 text-xs"></i><?php echo e(session('success')); ?>

                </span>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <span class="text-red-700 text-sm bg-red-50 border border-red-200 px-3 py-1.5 rounded-full flex items-center gap-1.5">
                    <i class="fas fa-exclamation-circle text-red-500 text-xs"></i><?php echo e(session('error')); ?>
            ...
            <div class="relative" id="notif-wrap">
                ...
                <div id="notif-panel"
                    ...
                    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                        <span class="text-sm font-semibold text-gray-800"><?php echo e(__('messages.notifications')); ?></span>
                        <button onclick="markAllNotifRead()" class="text-xs text-blue-600 hover:underline"><?php echo e(__('messages.mark_all_read')); ?></button>
                    </div>
                    <div id="notif-list" class="overflow-y-auto" style="max-height:360px">
                        <div class="flex items-center justify-center py-10 text-gray-400 text-xs" id="notif-empty">
                            <i class="fas fa-bell-slash mr-2"></i> <?php echo e(__('messages.no_notifications')); ?>

                        </div>
                    </div>
                    <div class="border-t border-gray-100 px-4 py-2 text-center">
                        <a href="<?php echo e(route('notifications.index')); ?>" class="text-xs text-blue-600 hover:underline"><?php echo e(__('messages.see_all_notifications')); ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="relative" id="profile-menu-wrap">
                <button onclick="toggleProfileMenu()" id="profile-btn"
                    ...
                    <?php if(auth()->user()->avatar && file_exists(public_path(auth()->user()->avatar))): ?>
                        <img src="<?php echo e(asset(auth()->user()->avatar)); ?>" alt="avatar" class="h-full w-full object-cover">
                    <?php else: ?>
                ...
                <div id="profile-dropdown"
                    ...
                    <div class="px-4 py-4 bg-gradient-to-r from-[#2453d6] to-blue-500 flex items-center gap-3">
                        <div class="relative group flex-shrink-0">
                            ...
                            <label class="absolute inset-0 rounded-full bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition">
                                ...
                                <form method="POST" action="<?php echo e(route('profile.avatar')); ?>" enctype="multipart/form-data" id="avatar-form">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="overflow-hidden min-w-0">
                            <p class="text-white font-semibold text-sm truncate"><?php echo e(auth()->user()->name); ?></p>
                            <p class="text-blue-200 text-xs truncate"><?php echo e(auth()->user()->email); ?></p>
                            <span class="inline-block mt-0.5 px-2 py-0.5 bg-white/20 rounded-full text-[10px] text-white font-medium"><?php echo e(ucfirst(auth()->user()->role ?? 'user')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="divide-y divide-gray-50 px-2 py-2">
                        ...
                        <form method="POST" action="<?php echo e(route('profile.display-name')); ?>" class="px-2 py-3" onsubmit="closeProfileMenu()">
                            <?php echo csrf_field(); ?>
                            <label class="block text-[11px] text-gray-500 font-medium mb-1.5 uppercase tracking-wide"><?php echo e(__('messages.display_name')); ?></label>
                        ...
                        <div class="px-2 py-3">
                            <button onclick="togglePwdPanel()" class="w-full flex items-center gap-2 text-sm text-gray-700 hover:text-blue-600 transition font-medium">
                                ...
                                <?php echo e(__('buttons.change_password')); ?>

                                <i class="fas fa-chevron-down text-xs ml-auto" id="pwd-chevron"></i>
                            </button>
                            <div id="pwd-panel" class="hidden mt-2">
                                <form method="POST" action="<?php echo e(route('profile.password')); ?>" onsubmit="closeProfileMenu()">
                                    <?php echo csrf_field(); ?>
                                    <div class="space-y-2">
                                        <input type="password" name="current_password" placeholder="<?php echo e(__('auth.current_password')); ?>"
                                            class="w-full border border-gray-200 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-300">
                                        <input type="password" name="password" placeholder="<?php echo e(__('auth.new_password')); ?>"
                                            class="w-full border border-gray-200 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-300">
                                        ...
                                        <button type="submit"
                                            ...
                                            <?php echo e(__('buttons.save_password')); ?>
                        ...
                        <?php $currentLang = session('locale', config('app.locale', 'fr')); ?>
                        <form method="POST" action="<?php echo e(route('profile.language')); ?>" class="px-2 py-3">
                            <?php echo csrf_field(); ?>
                            <label class="block text-[11px] text-gray-500 font-medium mb-1.5 uppercase tracking-wide"><?php echo e(__('messages.language')); ?></label>
                            <div class="flex items-center gap-2">
                                <select name="locale" class="flex-1 border border-gray-200 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-300">
                                    <option value="fr" <?php echo e($currentLang === 'fr' ? 'selected' : ''); ?>>&#127467;&#127479; Fran&ccedil;ais</option>
                                    <option value="en" <?php echo e($currentLang === 'en' ? 'selected' : ''); ?>>&#127468;&#127463; English</option>
                                    <option value="es" <?php echo e($currentLang === 'es' ? 'selected' : ''); ?>>&#127469;&#127480; Español</option>
                                    <option value="pt" <?php echo e($currentLang === 'pt' ? 'selected' : ''); ?>>&#127479;&#127481; Português</option>
                                    <option value="ar" <?php echo e($currentLang === 'ar' ? 'selected' : ''); ?>>&#127462;&#127466; العربية</option>
                                </select>
                                <button type="submit"
                                    class="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg transition">
                                    <?php echo e(__('buttons.ok')); ?>
                        ...
                        <div class="px-2 py-2 space-y-0.5">
                            <a href="<?php echo e(route('profile.edit')); ?>" onclick="closeProfileMenu()"
                                ...
                                <?php echo e(__('navigation.my_profile')); ?>
    ...
    <script>
    window.__trans = {
        new: "<?php echo e(__('messages.new')); ?>",
        save: "<?php echo e(__('messages.save')); ?>",
        cancel: "<?php echo e(__('messages.cancel')); ?>",
        delete: "<?php echo e(__('messages.delete')); ?>",
        edit: "<?php echo e(__('messages.edit')); ?>",
        confirm: "<?php echo e(__('messages.confirm')); ?>",
        close: "<?php echo e(__('messages.close')); ?>",
        loading: "<?php echo e(__('messages.loading')); ?>",
        search: "<?php echo e(__('messages.search')); ?>",
        error: "<?php echo e(__('messages.error')); ?>",
        success: "<?php echo e(__('messages.success')); ?>",
        import_files: "<?php echo e(__('messages.import_files')); ?>",
        import_folder: "<?php echo e(__('messages.import_folder')); ?>",
        new_folder: "<?php echo e(__('messages.new_folder')); ?>",
        word_document: "<?php echo e(__('messages.word_document')); ?>",
        no_documents: "<?php echo e(__('messages.no_documents')); ?>",
        see_all: "<?php echo e(__('messages.see_all')); ?>",
        status_signed: "<?php echo e(__('messages.status_signed')); ?>",
        status_draft: "<?php echo e(__('messages.status_draft')); ?>",
        status_pending: "<?php echo e(__('messages.status_pending')); ?>",
        ok: "<?php echo e(__('buttons.ok')); ?>",
        submit: "<?php echo e(__('buttons.submit')); ?>",
        download: "<?php echo e(__('buttons.download')); ?>",
        back: "<?php echo e(__('buttons.back')); ?>",
...
?>
<?php if($_chatShow && isset($_chatMe) && $_chatMe): ?>
    ...
    <div id="chat-panel" class="hidden flex-col bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden"
        ...
        <div id="chat-home" class="flex flex-col flex-1 overflow-hidden">
            ...
            <div id="chat-salons-list" class="flex-1 overflow-y-auto py-2">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$room, $label, $color, $icon, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button onclick="chatOpenSalon('<?php echo e($room); ?>','<?php echo e($label); ?>')"
                    class="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition text-left group">
                    <div class="h-9 w-9 rounded-xl bg-<?php echo e($color); ?>-100 flex items-center justify-center flex-shrink-0">
                        <i class="<?php echo e($icon); ?> text-<?php echo e($color); ?>-600 text-sm"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-gray-800"><?php echo e($label); ?></p>
                        <p class="text-xs text-gray-400 truncate"><?php echo e($desc); ?></p>
                    </div>
...
(function() {
    // ── URLs routes (Blade) ───────────────────────────────────
    var CHAT_MESSAGES_URL = '<?php echo e(route("chat.messages")); ?>';
    var CHAT_SEND_URL     = '<?php echo e(route("chat.send")); ?>';
    var CHAT_USERS_URL    = '<?php echo e(route("chat.users")); ?>';
    var CHAT_ONLINE_URL   = '<?php echo e(route("chat.online-by-administration")); ?>';
    ...
    var ME_ID     = '<?php echo e(auth()->id()); ?>';
    var ME_INIT   = '<?php echo e($_chatInit); ?>';
...
<div id="idle-overlay" style="display:none;position:fixed;inset:0;z-index:99999;background:rgba(15,23,42,0.7);backdrop-filter:blur(4px);align-items:center;justify-content:center;">
    <div style="background:#fff;border-radius:16px;box-shadow:0 25px 60px rgba(0,0,0,0.35);padding:40px 48px;max-width:420px;width:90%;text-align:center;position:relative;">
        ...
        <form id="idle-logout-form" method="POST" action="<?php echo e(route('logout')); ?>" style="margin:0;">
            <?php echo csrf_field(); ?>
...
<script>
(function () {
    var AJAX_URL     = '<?php echo e(route("notifications.ajaxList")); ?>';
    var READ_ALL_URL = '<?php echo e(route("notifications.readAll")); ?>';
    var READ_URL     = '<?php echo e(url("notifications")); ?>/';
