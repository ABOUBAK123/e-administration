...
<?php $__env->startSection('page-title', 'Mes Documents'); ?>
            ...
            <div id="share-admin" class="hidden space-y-3">
                ...
                <div>
                    ...
                    <select id="shareAdminId" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                        ...
                        <?php $__currentLoopData = $recipientAdministrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($admin->id); ?>" data-sector="<?php echo e(strtolower((string) (($admin->metadata['sector'] ?? '')) )); ?>"><?php echo e($admin->name); ?></option>
...
const _BASE = '<?php echo e(url("documents")); ?>';
const ROUTES = {
...
const OO_URL = <?php echo json_encode($onlyofficeUrl ?? '', 15, 512) ?>;
const RECIPIENT_ADMINS = <?php echo json_encode($recipientsJson, 15, 512) ?>;
const INTERNAL_USERS = <?php echo json_encode($internalUsersJson, 15, 512) ?>;
const INTERNAL_SUB_ENTITIES = <?php echo json_encode($internalSubEntitiesJson, 15, 512) ?>;

let allDocs = <?php echo json_encode($docsJson, 15, 512) ?>;
let prefs   = <?php echo json_encode($prefsJson, 15, 512) ?>;
